...
//        System.out.println("Normalized Histogram " + cs.obj.hist + " Normalized Histogram Starting");
    ...
    public void update_hue_image(Mat mRgba, Rect[] region, CamShifting cs) {
        ...
        Core.inRange(cs.obj.hsv, new Scalar(0, smin, Math.min(vmin, vmax)), new Scalar(180, 256, Math.max(vmin, vmax)),
                cs.obj.mask);
...
//        System.out.println("Tracked Rectangle " + cs.obj.prev_rect + " Tracked Rectangle");
//        System.out.println("Tracked Rectangle " + cs.obj.curr_box.boundingRect() + " New Rectangle");
